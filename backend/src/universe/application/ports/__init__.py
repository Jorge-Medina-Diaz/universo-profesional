...
class EducationRepository(Protocol):
    async def list(self, user_id: UUID) -> list[Education]: ...
...
class ExperienceRepository(Protocol):
    async def list(self, user_id: UUID) -> list[Experience]: ...
...
class CertificationRepository(Protocol):
    async def list(self, user_id: UUID) -> list[Certification]: ...
...
class CourseRepository(Protocol):
    async def list(self, user_id: UUID) -> list[Course]: ...
...
class AchievementRepository(Protocol):
    async def list(self, user_id: UUID) -> list[Achievement]: ...
...
class InterestRepository(Protocol):
    async def list(self, user_id: UUID) -> list[Interest]: ...
