...
const es = {
  ...
  hero: {
    ...
    demo: {
      u1: "Este fin de semana monté un ecommerce.",
      a1: "¡Qué interesante! ¿Quieres pasarme el enlace al repositorio y lo analizo?",
      u2: "No, ahora solo quiero charlar.",
      a2: "¡Genial! Cuéntame: ¿qué es lo más relevante que montaste, qué stack usaste, de qué era el ecommerce?",
      u3: "De cerámica artesanal. Next.js y Stripe — y el catálogo lo genera una IA a partir de fotos.",
      proposalTitle: "Ecommerce de cerámica artesanal",
      p1: "Stack",
      p2: "Lo distinto",
      p2v: "catálogo generado con IA desde fotos",
      nudge: "Lo del catálogo con IA suena a skill nueva — cuando quieras me cuentas más.",
    },
  },
  manifesto: {
  ...
  maintain: {
    ...
    sub: "Tú empiezas — con una frase, un enlace o un CV. El agente reacciona, se ofrece a investigar lo que traes, y tira del hilo con preguntas abiertas para que sigas contando.",
    tabs: { weekly: "Cada semana", day1: "Día 1", discovery: "Descubrimiento" },
    captions: {
      weekly: "Tú cuentas; él reacciona, se ofrece a mirar el repo y pregunta en abierto. Una frase tuya acaba siendo memoria estructurada.",
      day1: "Le pasas tu CV y lo lee entero: detecta tu experiencia, te la devuelve para revisar y luego pregunta en abierto sobre lo que más le llama.",
...
const en: typeof es = {
  ...
  hero: {
    ...
    demo: {
      u1: "I built an ecommerce site this weekend.",
      a1: "That's interesting! Want to send me the repo link so I can analyze it?",
      u2: "No, right now I just want to chat.",
      a2: "Great! Tell me: what's the most relevant thing you built, what stack did you use, what was the shop about?",
      u3: "Handmade ceramics. Next.js and Stripe — and the catalog is AI-generated from photos.",
      proposalTitle: "Handmade-ceramics ecommerce",
      p1: "Stack",
      p2: "The twist",
      p2v: "AI-generated catalog from photos",
      nudge: "That AI catalog sounds like a new skill — tell me more whenever you like.",
    },
  },
  manifesto: {
  ...
  maintain: {
    ...
    sub: "You start — with a sentence, a link or a CV. The agent reacts, offers to investigate what you bring, and pulls the thread with open questions so you keep talking.",
    tabs: { weekly: "Every week", day1: "Day 1", discovery: "Discovery" },
    captions: {
      weekly: "You talk; it reacts, offers to look at the repo and asks openly. One sentence of yours becomes structured memory.",
      day1: "Hand it your CV and it reads all of it: detects your experience, returns it for review, then asks openly about what stands out.",
